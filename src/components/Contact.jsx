...
const Contact = () => {
  return (
    <section
      className="py-20 mb-6 w-full bg-tertiaryText bg-opacity-15"
      id="contact"
    >
      <div className="align-element grid grid-cols-1 items-center sm:grid-cols-2">
        ...
        <div className="flex justify-center sm:justify-end mt-8 sm:mt-0">
          <a
            ...
            className="text-center p-5 flex items-center gap-x-3 text-lg rounded-2xl bg-gradientColor sm:hover:scale-105"
          >
